...
const HeroBanner = () => {
  return (
    <Box sx={{mt:{lg:'212px',xm:'70px'},ml:{sm:'50px'}}} position={'relative'} p={'20px'}>
        ...
        <Button variant="contained" color='error' href='#exercises' sx={{backgroundColor:'#ff2625',padding:'20px'}}>Explore Exercises</Button>
